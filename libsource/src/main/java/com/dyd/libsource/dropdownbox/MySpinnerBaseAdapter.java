...
public abstract class MySpinnerBaseAdapter<T> extends BaseAdapter {
    ...
    public MySpinnerBaseAdapter<T> setTextColor(@ColorInt int textColor) {
        this.textColor = textColor;
        return this;
    }

    public MySpinnerBaseAdapter<T> setBackgroundSelector(@DrawableRes int backgroundSelector) {
